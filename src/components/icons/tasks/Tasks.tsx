...
export default function TasksIcon() {
    return <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.icon}>
        <path d="M7.5 11.875H12.5" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M7.5 9.375H12.5" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path
